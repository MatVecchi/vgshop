...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full max-w-md rounded-4xl shadow-xl ${stepCircleContainerClassName} bg-slate-950/50 border-2 border-violet-800 shadow-[0_0_15px_theme('colors.violet.800')] dark:border-violet-600 dark:shadow-[0_0_15px_theme('colors.violet.600')]`}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    incomplete: { width: 0, backgroundColor: "rgb(2 6 23 / 0.5)" },
